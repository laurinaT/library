 ...
 */
final class Version20220220001648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE history ADD loan_date DATETIME DEFAULT NULL, ADD due_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE history DROP loan_date, DROP due_date');
